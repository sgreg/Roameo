 ...
 *
 */
public class ReadContactsDialog extends DialogFragment {
    private ReadContactsDialogListener mDialogListener;

    @Override
    public void onAttach(Context context) {
        super.onAttach(context);
        try {
            mDialogListener = (ReadContactsDialogListener) context;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setPositiveButton(R.string.contact_permission_yes,
        ...
        builder.setNegativeButton(R.string.contact_permission_no, null);

        return builder.create();
    }

    public interface ReadContactsDialogListener {
